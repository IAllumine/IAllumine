...
root_agent = LlmAgent(
    ...
    instruction=f"""Your role is to answer questions about shows and events at the Versailles Domain by using the provided tools. 
